export default function collectpage() {
  return (
    <div className="bg-[url('/Home.svg')] bg-cover min-h-[100vh] flex flex-col gap-20 p-6">
      ...
      <div className="bg-[#f2EFEA] shadow-2xl rounded-3xl flex flex-col justify-center gap-4 px-6 py-10 items-center">
